...
public class OpenJdkCallbackImpl implements Callback {

    JSEngine jsBasedEngine;

    private OpenJdkCallbackImpl(JSEngine jsBasedEngine) {
    ...
    public static Callback getInstance(JSEngine jsBasedEngine) {
        ...
        if (CALLBACK_INSTANCE == null) {
            CALLBACK_INSTANCE = new OpenJdkCallbackImpl(jsBasedEngine);
        }
